...
const Navbar: React.FC = () => {
  ...
  return (
   <nav className="sticky top-0 z-50 h-(--nav-h) border-b border-border-primary text-text-primary py-2 px-4 md:px-12 flex items-center justify-between bg-background-primary backdrop-blur-md">
